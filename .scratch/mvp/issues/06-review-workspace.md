...
with pagination. Bottom action bar: Prev / Shortlist / Flag / Reject / Next, with a position
indicator (e.g. 1/30). Shortlist/Flag/Reject set the candidate's review status; vacancy
