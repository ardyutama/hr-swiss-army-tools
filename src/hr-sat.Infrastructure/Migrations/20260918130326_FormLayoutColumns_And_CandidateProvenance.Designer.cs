...
namespace hr_sat.Infrastructure.Migrations
{
    ...
    [Migration("20260918130326_FormLayoutColumns_And_CandidateProvenance")]
    partial class FormLayoutColumns_And_CandidateProvenance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hr_sat.Domain.Candidates.CandidateFormResponse", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("hr_sat.Domain.Vacancies.FormLayout", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("hr_sat.Domain.Vacancies.FormLayout", b =>
                {
                    b.HasOne("hr_sat.Domain.Vacancies.Vacancy", null)
                        .WithOne("FormLayout")
                        .HasForeignKey("hr_sat.Domain.Vacancies.FormLayout", "VacancyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
