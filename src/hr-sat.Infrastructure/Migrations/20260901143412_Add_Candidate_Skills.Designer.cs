...
namespace hr_sat.Infrastructure.Migrations
{
    ...
    [Migration("20260901143412_Add_Candidate_Skills")]
    partial class Add_Candidate_Skills
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hr_sat.Domain.Candidates.CandidateSkill", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("CandidateId", "PhraseNormalized")
                        .IsUnique()
                    ...
                    b.ToTable("candidate_skill", null, t =>
                        {
                            t.HasCheckConstraint("candidate_skill_phrase_check", "char_length(btrim(phrase)) BETWEEN 1 AND 200");

                            t.HasCheckConstraint("candidate_skill_position_check", "position >= 1");
                        });
                });
